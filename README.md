...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/black-band-9db6#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/black-band-9db6
```

A live public deployment of this template is available at [https://black-band-9db6.templates.workers.dev](https://black-band-9db6.templates.workers.dev)
